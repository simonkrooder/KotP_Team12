...
def notify_send(recipient_id: str, subject: str, body: str, context: dict) -> dict:
    # For demo, just log and return a mock notification id
    import uuid
...
def load_instructions():
    # Refactored RequestForInformationAgent class
                ...
                if run.status == "requires_action" and run.required_action:
                    ...
                    for tool_call in run.required_action.submit_tool_outputs.tool_calls:
                        ...
                        while retries < max_retries:
                            try:
                                # Replace with actual toolset logic for RequestForInformationAgent
...
async def main():
    with project_client:
        ...
        while True:
            print("\nEnter your request for information context (type exit to finish): ", end="")
